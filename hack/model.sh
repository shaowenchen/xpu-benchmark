...
while [[ $# -gt 0 ]]; do
    ...
    --help|-h)
        ...
        echo ""
        echo "Options:"
        echo "  --model model_path     Download single model from HuggingFace"
        ...
        echo "  $0 --concurrent https://huggingface.co/Qwen/Qwen3-0.6B-Base https://huggingface.co/meta-llama/Llama-2-7b-chat-hf"
        echo "  $0 --model"
        exit 0
        ;;
    *)
...
if [ "$MODEL_MODE" = true ]; then
    ...
    echo "  $0 --model <model_path>     # Download single model"
